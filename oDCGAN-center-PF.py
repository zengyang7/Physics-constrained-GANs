...
for epoch in range(train_epoch+1):  
    ...
    #name = root + 'PF-oDCGAN-cons'+str(cons_value)+'-lam'+str(lam)+'-ep'+str(epoch)
...
name_data = root+'PF-oDCGAN-cons'+str(cons_value)+'-lam'+str(lam)+'-lr'+str(lr_setting)+'-ep'+str(epoch)
