...
for epoch in range(train_epoch+1):
    ...
    for iter in range(shuffled_set.shape[0] // batch_size):
        ...
        errG = G_loss_only.eval({z: z_, y_label: y_label_, y_fill: y_fill_, dx:d_x_, dy:d_y_, filtertf:filter_batch, isTrain: False})
        errdelta_real = divergence_mean.eval({z:z_, y_label:y_label_, y_fill:y_fill_, dx:d_x_, dy:d_y_,filtertf:filter_batch, isTrain: False})
